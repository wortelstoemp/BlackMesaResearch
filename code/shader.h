	...
	char* fragSource)
{
	...
	program->tesselationControlShader = CompileAndAttachShader(program->shaderProgram, tessControlSource, GL_VERTEX_SHADER);
	program->tesselationEvaluationShader = CompileAndAttachShader(program->shaderProgram, tessEvalSource, GL_VERTEX_SHADER);
	program->fragmentShader = CompileAndAttachShader(program->shaderProgram, fragSource, GL_VERTEX_SHADER);
